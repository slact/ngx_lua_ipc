...
typedef enum {IPC_NGX_PROCESS_UNKNOWN = 0, IPC_NGX_PROCESS_WORKER, IPC_NGX_PROCESS_CACHE_MANAGER, IPC_NGX_PROCESS_CACHE_LOADER,  IPC_NGX_PROCESS_ANY} ipc_ngx_process_type_t;
